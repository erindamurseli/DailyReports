...
class Titulli implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($Titulli)
    {
...

    {
        ...
        return RaportetDitore::where('Titulli', $this->Titulli)->get();
