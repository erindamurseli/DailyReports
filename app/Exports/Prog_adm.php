...
class Prog_adm implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($Prog_adm)
    {
        $this->Prog_adm = $Prog_adm;
    }
...

    {
        ...
        return RaportetDitore::where('Prog_adm', $this->Prog_adm)->get();
