...
class KNP implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($KNP)
    {
        $this->KNP = $KNP;
    }
...

    {
        ...
        return RaportetDitore::where('KNP', $this->KNP)->get();
