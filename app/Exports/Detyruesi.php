...
class Detyruesi implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($Detyruesi)
    {
        $this->Detyruesi = $Detyruesi;
    }
...

    {
        ...
        return RaportetDitore::where('Detyruesi', $this->Detyruesi)->get();
