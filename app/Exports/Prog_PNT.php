...
class Prog_PNT implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($Prog_PNT)
    {
        $this->Prog_PNT = $Prog_PNT;
    }
...

    {
        ...
        return RaportetDitore::where('Prog_PNT', $this->Prog_PNT)->get();
