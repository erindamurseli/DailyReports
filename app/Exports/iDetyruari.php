...
class iDetyruari implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    protected $iDetyruari;

    public function __construct($iDetyruari)
    {
        $this->iDetyruari = $iDetyruari;
    }
...

    {
        ...
        return RaportetDitore::where('iDetyruari', $this->iDetyruari)->get();
