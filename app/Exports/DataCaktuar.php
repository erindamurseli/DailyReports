...
class DataCaktuar implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    protected $DataCaktuar;

    public function __construct($DataCaktuar)
    {
        $this->DataCaktuar = $DataCaktuar;
    }
...

    {
        ...
        return RaportetDitore::where('DataCaktuar', $this->DataCaktuar)->get();
