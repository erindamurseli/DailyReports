...
class DataKryer implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($DataKryer)
    {
        $this->DataKryer = $DataKryer;
    }
...

    {
        ...
        return RaportetDitore::where('DataKryer', $this->DataKryer)->get();
