...
class Sektori implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($Sektori)
    {
...

    {
        ...
        return RaportetDitore::where('Sektori', $this->Sektori)->get();
