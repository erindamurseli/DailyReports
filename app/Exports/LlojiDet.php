...
class LlojiDet implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($LlojiDet)
    {
        $this->LlojiDet = $LlojiDet;
    }
...

    {
        ...
        return RaportetDitore::where('LlojiDet', $this->LlojiDet)->get();
