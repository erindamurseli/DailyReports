...
class RaportiRD implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    protected $prioriteti;

    public function __construct($prioriteti)
    {
...

    {
        ...
        return RaportetDitore::where('Prioriteti', $this->prioriteti)->get();
