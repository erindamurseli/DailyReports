...
class LlDoc implements FromCollection ,WithHeadings,WithColumnWidths,WithStyles,  ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    public function __construct($LlDoc)
    {
        $this->LlDoc = $LlDoc;
    }
...

    {
        ...
        return RaportetDitore::where('LlDoc', $this->LlDoc)->get();
